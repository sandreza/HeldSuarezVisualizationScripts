...
title_names = []
# 1
push!(filename, "data/avg_earth_hs_he_12_hp_4_ve_12_vp_4_roefanov.jld2")
push!(title_names, "truth")

# 2
push!(filename, "data/avg_earth_hs_he_15_hp_1_ve_15_vp_1_roefanov.jld2")
push!(title_names, "pₕ = 1 , pᵥ = 1")

# 3
push!(filename, "data/avg_earth_hs_he_10_hp_2_ve_10_vp_2_roefanov.jld2")
push!(title_names, "pₕ = 2 , pᵥ = 2")

# 4
push!(filename, "data/avg_earth_hs_he_6_hp_4_ve_15_vp_1_roefanov.jld2")
push!(title_names, "pₕ = 4 , pᵥ = 1")

# 5 
push!(filename, "data/avg_earth_hs_he_6_hp_4_ve_6_vp_4_roefanov.jld2")
push!(title_names, "pₕ = 4 , pᵥ = 4")

# 6 
push!(filename, "data/avg_earth_hs_he_5_hp_5_ve_5_vp_5_roefanov.jld2")
